         ...
         <b-row class="head d-flex align-items-center">
           <b-col md="6">
            <div class="float-left pl-35">
              <img src="img/alkemi-logo-horizontal-all-white.svg" alt="Alkemi"/>
          ...
          <b-col md="6">
            <div class="float-right pr-35">
               <b-button-group v-if="!isConnect">
                <b-button @click="connectWallet" variant="akm">Connect</b-button>
              </b-button-group>
              <div v-if="isConnect" class="d-flex flex-row-reverse bd-highlight">
                  ...
                  <b-tabs pills card vertical>
                    <b-tab> 
                      <template v-slot:title>
                        ...
                        <div class="acronym-name content-mid">OMG 
                          <div class="name-el-money">Omise GO</div>
                        </div>
                        <div class="content-mid">120,000.34
                        ...
                        <template>
                          <div>
                            <div class="info-value">
                              ...
                              <span class="acronym-name">OMG | <span class="el-name">Omise GO</span></span>
                              <div class="clearfix"></div>
                              <div class="est-value">$9344.44 | <span class="text-est">EST USD VALUE</span></div>
                            </div>
                            <div class="chart-line">
                              <div class="info-chart">
                                <div class="value-change float-left">24 HR CHANGE
                                  <div class="percent">+5.55 %</div>
                                </div>
                                <div class="value-change float-left">TOKEN EARNINGS
                                  <div class="est-value-change">+29,322.34</div>
                                </div>
                                <div class="value-change float-left">USD VALUE EARNINGS
                                  <div class="est-value-change">+ $12,333.12</div>
                                </div>
                              </div>
                              <div class="clearfix"></div>
                            ...
                            <div class="form-reserve">
                              ...
                              <div class="float-right"><b-button variant="add-new" @click="showModal">+ Add New</b-button></div>
                              <b-modal hide-header ref="my-modal" hide-footer title="Using Component Methods" id ="modal-add">
                                ...
                                <div class="content-modal">
                                  <b-form>
                                    ...
                                    <b-button class="btn-submit btn-modal-add-new" type="submit">CREATE POOL</b-button>
                              ...
                              <b-table :items="items" :fields="fields">
                                <template v-slot:cell(btn)="row">
                                  <b-button v-if="!row.item.btn" size="sm" class="btn-claim">
                                    CLAIM
                                  </b-button>
                                  <b-button v-if="row.item.btn" size="sm" class="btn-claim-value">
                                    {{row.item.btn}}
                                  </b-button>
                                </template>
                              </b-table>
                    ...
                    <b-tab>
                      <template v-slot:title>
                        ...
                        <div class="acronym-name content-mid">DAI 
                          <div class="name-el-money">Maker Dai</div>
                        </div>
                        <div class="content-mid">2,344,333.76
                    ...
                    <b-tab>
                      <template v-slot:title>
                        ...
                        <div class="acronym-name content-mid">EOS 
                          <div class="name-el-money">EOS</div>
                        </div>
                        <div class="content-mid">182,382.28
                    ...
                    <b-tab>
                      <template v-slot:title>
                        ...
                        <div class="acronym-name content-mid">MKR 
                          <div class="name-el-money">Maker</div>
                        </div>
                        <div class="content-mid">65,844.57
                    ...
                    <b-tab>
                      <template v-slot:title>
                        ...
                        <div class="acronym-name content-mid">BNB 
